window.onload = async () => {
    ...
    let query = new URLSearchParams(location.search) //capturo el contenido del query string
    const id = query.has('movie') && query.get('movie') // si existe movie , traeme el contenido
